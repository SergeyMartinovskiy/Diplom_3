...
class TestPersonalAccountPage:
    ...
    def test_click_button_transfer_to_personal_account(self, driver):
        ...
        assert personal_page.title_enter_personal_account() == 'Вход'
    ...
    def test_click_button_transfer_to_personal_account(self, driver):
        ...
        main_page.click_personal_account_button()
        assert personal_page.title_in_personal_account() == 'В этом разделе вы можете изменить свои персональные данные'
